#Implement a linear regression model using scikit-learn for the
# simulated dataset - simulated_data_multiple_linear_regression_for_ML.csv
...
print(df)
print(df.size)
# another medthod to get rows & column = df.drop("disease_score_fluct" ,axis=1,inplace=True)
# print(df)
X=df.iloc[:,0:5]
y=df.iloc[:,6]
print(X)

...
def main():
    ...
    # random sampling of longitude & latitude data
    import numpy as np
...
# making a pair plot of all features and the target but dropping the longitude and latitude.
# We will quantize the target such that we can create proper histogram.
    import pandas as pd
...
#Thus, creating a predictive model,
# we could expect the longitude, latitude,
# and the median income to be useful features to help a
# t predicting the median house values.

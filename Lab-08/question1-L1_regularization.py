...
lamb = 1            #                                  #  for Hyper Parameter for regularization
#------------------------------------------------------#
#======================================================#
...
def deriv_fun(x, y, theta, i3):
    ...
    for i2 in range(len(x)):
            z += (hypothesis_fun(x, theta, i2) - y[i2]) * x[i2][i3]   # here added lasso regularization
    return z
    ...
    def get_theta(theta, x, y, alpha, iteration, tol,lamb):
        ...
        for itr in range(iteration):
            ...
            for i3 in range(len(theta)):
                ...
                if theta[0] > 0:
                    new_theta[i3] = theta[i3] - alpha * (deriv_fun(x, y, theta, i3) + lamb)

...
tol = 1e-15         #                                  #      # Toleration limit fopr diffrence between 2 theta
#------------------------------------------------------#
#======================================================#
...
X_train1, X_test1, y_train, y_test = train_test_split(X, y, test_size=0.3, random_state=999)
print(X_test1.info)
n,d=X_train1.shape
...
XX_train=X_train1
X_train=norm_data(X_train1,X_train1)
X_test=norm_data(XX_train,X_test1)
...
def main():
    ...
    accuracy_sci = accuracy_score(y_test, y_pred)
    #=======================================================================================#

    #==================================PRINT================================================#
    print(f"final accuracy of Scratch Method : {accuracy} ")
    print("")
    print(f"final accuracy of Scikit Method : {accuracy_sci} ")
    # =======================================================================================#
